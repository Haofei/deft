...
pub struct Scrollable {
    ...
    momentum_info: Option<crate::ui::scroll::MomentumInfo>,
...
impl Scrollable {
    ...
    pub fn on_event(
        ...
        if accepted {
            ...
            if let Some(e) = TouchStartEvent::cast(event) {
                ...
                self.momentum_info = Some(crate::ui::scroll::MomentumInfo {
                ...
                if let Some(momentum_info) = &mut self.momentum_info {
                    if momentum_info.start_time.elapsed().as_millis() as f32
                        > crate::ui::scroll::MOMENTUM_DURATION
                    {
                ...
                if let Some(momentum_info) = &self.momentum_info {
                    ...
                    if duration < crate::ui::scroll::MOMENTUM_DURATION
                        && max_distance > crate::ui::scroll::MOMENTUM_DISTANCE
                    {
                        let horizontal_speed =
                            crate::ui::scroll::calculate_speed(horizontal_distance, duration);
                        let vertical_speed =
                            crate::ui::scroll::calculate_speed(vertical_distance, duration);
                        ...
                        let fc = WindowAnimationController::new(BoxedStyleListener::new(element.as_weak()));
                        let mut ai =
    ...
    pub fn update_layout(&mut self, node: &mut StyleNode) {
        ...
        //     return;
        // }
        let border = node.get_border_width();
    ...
    fn do_layout_content(&mut self, element: &mut StyleNode, bounds_width: f32, bounds_height: f32) {
        ...
        if old_vertical_bar_visible != new_vertical_bar_visible {
            ...
            self.vertical_bar.set_length(bounds_height, real_content_height, bounds_width);
        }
    ...
    pub fn layout_content(&mut self, element: &mut StyleNode, bounds_width: f32, bounds_height: f32) {
